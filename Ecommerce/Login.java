...
public class Login {
    ...
    public static Customer customerLogin(String userEmail, String password) throws NoSuchAlgorithmException {
        //select * from customers where email = 'swapna@gmail.com' and password = 'abc';
...
//        System.out.println(customerLogin("vipul@gmail.com", "abc"));
//        boolean isValid = customerLogin("vipul@gmail.com", "abc");
